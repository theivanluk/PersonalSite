import { sanity_abouts, sanity_experiences, sanity_skills, sanity_works } from "../Constants/sanityTypeNames";
...
export default class SanityDataAccess implements IDataAccess {
  ...
  async getExperience(): Promise<IExperiencesSanityAPI[]> {
    return <IExperiencesSanityAPI[]> await sanityClient.fetch(sanityQuery(sanity_experiences));
  }
